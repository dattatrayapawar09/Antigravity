...
from app.routes import auth, debug, instruments, equity, scanner, smart_reversal_options
...
app.include_router(smart_reversal_options.router)    # GET /api/scanner/smart-reversal-options
